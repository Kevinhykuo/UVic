...
am = f2*60        #Converts degrees to arcminute
ss = 10             #Steps to take per arcminute
s = am*1000          #How many total steps to take
...
theta90 = WF_THETA(pi/2) #Calculate the probability at 90 degrees
...
# Plot it out
plt.title(r'Polar component of a d electron wave-function in a hydrogen-like atom', fontsize=12)
...
print((d/ss)/6000) #Convert to arcminuite (1 degree = 3600 arcminuite)
print(' ')
print('Angles where possibility is near 0 (radians):')
print(((d/ss)/6000)/180, 'pi' )
